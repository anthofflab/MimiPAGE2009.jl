...
@defcomp AbatementScale begin
    ...
    emissiongrowthfactor_CO2 = Parameter(index=[time,region], unit="% of normal growth")
    emissiongrowthfactor_CH4 = Parameter(index=[time,region], unit="% of normal growth")
    emissiongrowthfactor_N2O = Parameter(index=[time,region], unit="% of normal growth")
    emissiongrowthfactor_LG = Parameter(index=[time,region], unit="% of normal growth")
...
function run_timestep(s::AbatementScale, tt::Int64)
    ...
    for rr in d.region
        v.er_CO2emissionsgrowth_new[tt, rr] = p.er_CO2emissionsgrowth[tt, rr] * p.emissiongrowthfactor_CO2[tt,rr] / 100
        v.er_CH4emissionsgrowth_new[tt, rr] = p.er_CH4emissionsgrowth[tt, rr] * p.emissiongrowthfactor_CH4[tt,rr] / 100
        v.er_N2Oemissionsgrowth_new[tt, rr] = p.er_N2Oemissionsgrowth[tt, rr] * p.emissiongrowthfactor_N2O[tt,rr] / 100
        v.er_LGemissionsgrowth_new[tt, rr] = p.er_LGemissionsgrowth[tt, rr] * p.emissiongrowthfactor_LG[tt,rr] / 100
    end
end
...
setparameter(m, :AbatementScale, :emissiongrowthfactor_CO2, repmat([100.], 10, 8))
setparameter(m, :AbatementScale, :emissiongrowthfactor_CH4, repmat([100.], 10, 8))
setparameter(m, :AbatementScale, :emissiongrowthfactor_N2O, repmat([100.], 10, 8))
setparameter(m, :AbatementScale, :emissiongrowthfactor_LG, repmat([100.], 10, 8))
...
optprob = problem(m, [:AbatementScale, :AbatementScale, :AbatementScale, :AbatementScale], [:emissiongrowthfactor_CO2, :emissiongrowthfactor_CH4, :emissiongrowthfactor_N2O, :emissiongrowthfactor_LG], repmat([0.], 40,8), repmat([100.0], 40,8), bestpolicy)
