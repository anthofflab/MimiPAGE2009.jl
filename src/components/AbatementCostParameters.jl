...
function addabatementcostparameters(model::Model, class::Symbol, policy::String="policy-a")
    ...
    if class == :CO2
        MimiPAGE2009.setdistinctparameter(model, componentname, :emit_UncertaintyinBAUEmissFactorinFocusRegioninFinalYear, 8.333333333333334)
        MimiPAGE2009.setdistinctparameter(model, componentname, :q0propinit_CutbacksinNegativeCostinFocusRegioninBaseYear, 20.)
        MimiPAGE2009.setdistinctparameter(model, componentname, :c0init_MostNegativeCostCutbackinBaseYear, -233.333333333333)
        MimiPAGE2009.setdistinctparameter(model, componentname, :qmaxminusq0propinit_MaxCutbackCostatPositiveCostinBaseYear, 70.)
        MimiPAGE2009.setdistinctparameter(model, componentname, :cmaxinit_MaximumCutbackCostinFocusRegioninBaseYear, 400.)
        MimiPAGE2009.setdistinctparameter(model, componentname, :ies_InitialExperienceStockofCutbacks, 150000.)
        ...
        MimiPAGE2009.setdistinctparameter(model, componentname, :bau_businessasusualemissions, MimiPAGE2009.readpagedata(model, "data/bau_co2emissions.csv"))
    elseif class == :CH4
        MimiPAGE2009.setdistinctparameter(model, componentname, :emit_UncertaintyinBAUEmissFactorinFocusRegioninFinalYear, 25.)
        MimiPAGE2009.setdistinctparameter(model, componentname, :q0propinit_CutbacksinNegativeCostinFocusRegioninBaseYear, 10.)
        MimiPAGE2009.setdistinctparameter(model, componentname, :c0init_MostNegativeCostCutbackinBaseYear, -4333.3333333333333)
        MimiPAGE2009.setdistinctparameter(model, componentname, :qmaxminusq0propinit_MaxCutbackCostatPositiveCostinBaseYear, 51.66666666666666664)
        MimiPAGE2009.setdistinctparameter(model, componentname, :cmaxinit_MaximumCutbackCostinFocusRegioninBaseYear, 6333.33333333333)
        MimiPAGE2009.setdistinctparameter(model, componentname, :ies_InitialExperienceStockofCutbacks, 2000.)
        ...
        MimiPAGE2009.setdistinctparameter(model, componentname, :bau_businessasusualemissions, MimiPAGE2009.readpagedata(model, "data/bau_ch4emissions.csv"))
    elseif class == :N2O
        MimiPAGE2009.setdistinctparameter(model, componentname, :emit_UncertaintyinBAUEmissFactorinFocusRegioninFinalYear, 0.)
        MimiPAGE2009.setdistinctparameter(model, componentname, :q0propinit_CutbacksinNegativeCostinFocusRegioninBaseYear, 10.)
        MimiPAGE2009.setdistinctparameter(model, componentname, :c0init_MostNegativeCostCutbackinBaseYear, -7333.333333333333)
        MimiPAGE2009.setdistinctparameter(model, componentname, :qmaxminusq0propinit_MaxCutbackCostatPositiveCostinBaseYear, 51.66666666666666664)
        MimiPAGE2009.setdistinctparameter(model, componentname, :cmaxinit_MaximumCutbackCostinFocusRegioninBaseYear, 27333.3333333333)
        MimiPAGE2009.setdistinctparameter(model, componentname, :ies_InitialExperienceStockofCutbacks, 53.3333333333333)
        ...
        MimiPAGE2009.setdistinctparameter(model, componentname, :bau_businessasusualemissions, MimiPAGE2009.readpagedata(model, "data/bau_n2oemissions.csv"))
    elseif class == :Lin
        MimiPAGE2009.setdistinctparameter(model, componentname, :emit_UncertaintyinBAUEmissFactorinFocusRegioninFinalYear, 0.)
        MimiPAGE2009.setdistinctparameter(model, componentname, :q0propinit_CutbacksinNegativeCostinFocusRegioninBaseYear, 10.)
        MimiPAGE2009.setdistinctparameter(model, componentname, :c0init_MostNegativeCostCutbackinBaseYear, -233.333333333333)
        MimiPAGE2009.setdistinctparameter(model, componentname, :qmaxminusq0propinit_MaxCutbackCostatPositiveCostinBaseYear, 70.)
        MimiPAGE2009.setdistinctparameter(model, componentname, :cmaxinit_MaximumCutbackCostinFocusRegioninBaseYear, 333.333333333333)
        MimiPAGE2009.setdistinctparameter(model, componentname, :ies_InitialExperienceStockofCutbacks, 2000.)
        ...
        MimiPAGE2009.setdistinctparameter(model, componentname, :bau_businessasusualemissions, MimiPAGE2009.readpagedata(model,"data/bau_linemissions.csv"))
    else
