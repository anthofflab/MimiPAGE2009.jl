...
@test adaptation ≈ adaptation_compare atol=1e-2
...
@test damages ≈ damages_compare atol=10
#SLR damages
...
@test slrdamages ≈ slrdamages_compare atol=0.1
#Market damages
...
@test mdamages ≈ mdamages_compare atol=1
#NonMarket Damages
...
@test nmdamages ≈ nmdamages_compare atol=1

te = m[:EquityWeighting, :te_totaleffect]
te_compare = 213208136.69903600
@test te ≈ te_compare atol=1e4
