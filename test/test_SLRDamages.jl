...
@test_approx_eq_eps ones(10, 8) cons_percap_aftercosts ./ cons_percap_aftercosts_compare .01
...
@test_approx_eq_eps i_regionalimpactSLR i_regionalimpactSLR_compare .01
...
@test_approx_eq_eps iref_ImpactatReferenceGDPperCapSLR iref_ImpactatReferenceGDPperCapSLR_compare .01
...
@test_approx_eq_eps ones(10, 8) rcons_per_cap_SLRRemainConsumption ./ rcons_per_cap_SLRRemainConsumption_compare .01
...
@test_approx_eq_eps ones(10, 8) rgdp_per_cap_SLRRemainGDP ./ rgdp_per_cap_SLRRemainGDP_compare .01
...
@test_approx_eq_eps isat_ImpactinclSaturationandAdaptationSLR isat_ImpactinclSaturationandAdaptationSLR_compare .01
