...
set_param!(m, :SLRDamages, :imp_actualreductionSLR, readpagedata(m, "test/validationdata/imp_actualreductionSLR.csv"))
...
set_param!(m, :SLRDamages, :wincf_weightsfactor, readpagedata(m, "data/wincf_weightsfactor.csv"))
