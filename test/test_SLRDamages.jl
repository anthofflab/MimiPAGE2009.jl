...
setparameter(m, :SLRDamages, :s_sealevel, zeros(10, 8))
setparameter(m, :SLRDamages, :WINCF_weightsfactor, zeros(8))
setparameter(m, :SLRDamages, :rgdp_per_cap_SLRRemainGDP, zeros(10, 8))
setparameter(m, :SLRDamages, :GDP_per_cap_focus_0_FocusRegionEU, float(30000))
setparameter(m, :SLRDamages, :impmax_maxtempriseforadaptpolicySLR, ones(8))
